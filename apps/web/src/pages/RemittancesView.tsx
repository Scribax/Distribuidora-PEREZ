      ...
      <form className="form remito-edit-form" onSubmit={onSaveEdit}>
        <fieldset disabled={savingEdit}>
          <div className="payment-grid remito-edit-payment">
            <label className="field-card"><span>Fecha de la boleta</span><input name="fecha" type="date" defaultValue={dateInput(selected.fecha)} required /><small>La fecha real de la factura, no la de carga.</small></label>
